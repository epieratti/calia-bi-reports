...
meta:
  ...
  subtitle: Risco de imagem para campanha de loterias — três novos nomes (lote 04/05/2026).
...
quality_calibration:
  data_corte_coleta: "04/05/2026 (referência painéis; ver meta.periodo)"
  delta_vs_entrega_anterior: Novo lote com três creators não presentes nos levantamentos anteriores (squad 13 e squad 8). Critérios alinhados ao lote de 06/04/2026.
  definicoes_prova:
    concorrencia: Vínculo com outras loterias, casas de apostas, cassino ou jogos de azar; humor que cite aposta de forma que possa ser lido como associação indevida; distinguir publi paga de menção educativa.
    polemicas: Falas ou episódios com risco de imagem com evidência em imprensa ou padrão recorrente nas redes.
    politica: Filiação, candidatura, proximidade com figuras/partidos com prova documentada.
briefing:
  perfis_institucionais: []
  intro_paragraphs:
  - Este dossiê avalia **risco de imagem (brand safety)** para uma campanha de loterias da Caixa com **três
    influenciadores** do squad Always ON 2026 — lote solicitado em maio/2026. Nas páginas seguintes, o que
    foi verificado em cada eixo; o **método** está em **Como foi analisado**.
  - Quando dizemos que **não encontramos** algo, quer dizer que **não apareceu** nas fontes públicas que
    usamos neste levantamento. Pode haver outros dados fora do escopo. Verificações finais contratuais
    (TSE, assessoria, exclusividade) devem ser feitas pelo atendimento antes da assinatura.
  criterios:
...
methodology:
  ...
  - label: Política e eleições (2026)
    body: 'Olhamos **filiação** (TSE), **candidatura** e **proximidade** com **governo / PT / Lula / Planalto**
      ...
      recorrente. Em ano eleitoral, monitoramento contínuo é recomendado durante a vigência do contrato.

      '
executive_summary:
  tagline: 'Três novos nomes do squad Always ON — levantamento de brand safety (mai/2026). Detalhe por
    pessoa em **Perfis** e na **tabela resumo**.'
  blocks:
  ...
  - title: Oportunidades de conteúdo
    ...
    - '**Linnyke:** "topo de funil" — humor de identificação popular; série estilo "O que você faria com
      o prêmio?" conecta diretamente ao universo das Loterias.'
    - '**Hatori:** conteúdo educativo e transparente — ideal para produtos diários (Quina, Lotofácil) e
      para mostrar o destino social das arrecadações. Histórico com Itaú/Nubank indica familiaridade com
      compliance bancário.'
    - '**Julimara:** regionalização e impacto social — viagens e experiências como realização de sonho;
      foco em Minas Gerais (estado-chave em 2026) sem polarização política.'
consolidated_narrative:
  title: Síntese do lote
  subtitle: __04/05/2026__ — três creators em **humor**, **lifestyle** e **entretenimento regional**.
...
Comediante e criador de conteúdo com forte presença no TikTok (≈ 1,9 M de seguidores) e no Instagram (1,8 M, engajamento de 6,65%). Faz entrevistas de rua e esquetes com personagens, geralmente usando paletó e óculos de sol como marca visual — o "entrevistador de terno" que transita entre diferentes estratos sociais. Começou a postar em abril de 2020 e cresceu principalmente nos formatos curtos. Em setembro de 2024, um de seus vídeos mais virais mostrava-o num mercado de rua incentivando o público a gritar. Também faz stand-up; um de seus shows é citado no [**Jornal da Paraíba**](https://jornaldaparaiba.com.br/guia-qualaboa/agenda/linnyke-alves-em-joao-pessoa) como evento em João Pessoa. Em 2024, mobilizou redes e arrecadou mais de R$ 400 mil para a casa própria de uma criança carente, segundo o [**Jornal do Rap**](https://www.jornaldorap.com.br/noticias/linnyke-alves-mobiliza-redes-sociais-e-arrecada-mais-de-r-400-mil-para-realizar-o-sonho-da-casa-propria-de-crianca-carente/). Não foram localizadas marcas nomeadas em campanhas publicitárias para este perfil nas fontes consultadas; seu histórico público é de parcerias com varejo regional e eventos de entretenimento.
...
Baixo — perfil de maior segurança jurídica e institucional do lote
...
Baixo — verificar cláusula de exclusividade com parceria de seguro viagem
