...
briefing:
  ...
  - '**Dados demográficos e de idade da audiência** costumam ser exibidos pela **plataforma** apenas para o
    **titular do perfil** (painéis internos / insights). Por isso **não** há como reproduzir esses números nesta
    coleta **com fontes públicas**.'
  criterios:
...
methodology:
  ...
  loterias_18_note: |
    ...
    **Demografia / idade de audiência:** as redes costumam mostrar esse recorte **só** para quem **administra** o
    perfil (insights / painel do criador). **Não** há acesso a isso neste relatório **sem** esses dados **compartilhados**
    pelo titular ou pela agência; o corpo trata do que está **público**, com **link**.
executive_summary:
  ...
  - title: Concorrência (bets / loterias)
    ...
    - Nenhum dos três tem publi ou parceria com aposta, cassino ou loteria concorrente nas fontes
      consultadas. Parcerias **fora** do público **não** entraram nesta coleta.
  - title: Polêmicas
    items:
    - Sem episódio de risco **documentado** nos três. **Felipe Hatori** integra **Os Japas**; matérias sobre
...
consolidated_narrative:
  ...
  - title: Leitura para Caixa
    items:
    - "**Quatro eixos** por perfil — **Concorrência**, **Polêmicas**, **Política** e **Loterias 18+** — com base nas
      **fontes públicas** e, no **18+**, na **amostra visual** (**mai/2026**). **Linnyke:** **baixo** nos três primeiros;
      **Loterias 18+** **elevada** (**menor de idade recorrente nas miniaturas** do feed). **Felipe** e **Julimara:**
      **baixo** nos três primeiros; **Loterias 18+** **baixa** (**Felipe**) e **baixa a moderada** (**Julimara**)."
    - "**Estilos:** humor de massa (**Linnyke**), humor urbano (**Felipe**), turismo e lifestyle regional (**Julimara**).
      **Alcance e engajamento** em **Métricas nas redes** (**corte 04/05/2026**)."
---
...
Sem filiação, candidatura ou posicionamento político documentado. **Ano eleitoral de 2026:** nas fontes desta coleta, **sem** posicionamento partidário explícito até a data do recorte.
...
Sem polêmica nas fontes. **Contexto:** integrante dos **Os Japas**; cobertura sobre **outros integrantes** pode citar o coletivo.
