...
meta:
  ...
  subtitle: Risco de imagem — três novos nomes (lote 04/05/2026).
...
briefing:
  ...
  - 'Loterias 18+ (jogo 18+): verificamos o que está público no perfil — **menor de idade em vídeo,
    capa ou série recorrente**, e menções a **menores de idade** em **matérias com link**. **Não**
    estimamos **percentual de seguidores menores de 18 anos**: em geral isso só aparece nos painéis
    internos da rede, com login do canal, e mesmo assim o dado costuma ser **instável** (idade
    mínima da plataforma, uso da conta de adulto, etc.). Passo a passo em **Jogo 18+ e leitura de
    público** (Como foi analisado); síntese por nome no bloco **Loterias 18+** de cada perfil e nas
...
methodology:
  ...
  loterias_18_note: |
    **Loterias** são **jogo para maiores de 18 anos**. Aqui **não** estimamos **quantos seguidores têm menos
    de 18 anos** — em geral isso só aparece nos **painéis internos** da rede, com acesso de quem administra o
    perfil (e às vezes da agência), e o número ainda costuma ser **pouco confiável** para falar em **audiência
    em idade inferior a 18 anos** (idade mínima da plataforma, uso do aparelho ou da conta por adulto, etc.).
...
executive_summary:
  ...
  - title: Loterias 18+ (jogo 18+)
    ...
    - Avaliamos o **trecho público do feed** (maio/2026) e matérias com link. **Não** há neste dossiê
      **percentual de seguidores menores de 18 anos** — dado que **não** é possível **estimar de forma confiável**
      apenas com fontes abertas.
    - "**Linnyke** concentra a atenção neste eixo: **menor de idade em cena com frequência** no que vimos do feed
      e na imprensa linkada. **Felipe** e **Julimara** apresentam **menor relevância** no mesmo recorte — humor adulto
      sem **menor de idade em destaque nas capas**, e viagem/natureza sem destaque de menor. O detalhe está no
      bloco **Loterias 18+** de cada um e na **tabela resumo**."
...
Comediante com 1,9 M no TikTok e 1,8 M no Instagram (6,65% de engajamento). Entrevistas de rua e esquetes com personagens, usando paletó e óculos de sol como marca visual. Começou em abril de 2020 ([**Famous Birthdays**](https://pt.famousbirthdays.com/people/linnyke-alves.html)) e tem stand-up ativo — show em João Pessoa citado no [**Jornal da Paraíba**](https://jornaldaparaiba.com.br/guia-qualaboa/agenda/linnyke-alves-em-joao-pessoa). Em 2024, arrecadou mais de R$ 400 mil para moradia de **beneficiário menor de idade** em situação de vulnerabilidade ([**Jornal do Rap**](https://www.jornaldorap.com.br/noticias/linnyke-alves-mobiliza-redes-sociais-e-arrecada-mais-de-r-400-mil-para-realizar-o-sonho-da-casa-propria-de-crianca-carente/)). Sem marcas nomeadas em campanhas nas fontes consultadas.
...
**Não** localizada publi de apostas, loteria concorrente ou jogos de azar. Menções a "sorte" e "ficar rico" são léxico do humor popular — sem CTA, sem link de afiliado, sem marcação de publi até mai/2026.

### Polêmicas e situações delicadas

Sem episódio de risco. A arrecadação de R$ 400 mil para **beneficiário menor de idade** em situação de vulnerabilidade ([**Jornal do Rap**](https://www.jornaldorap.com.br/noticias/linnyke-alves-mobiliza-redes-sociais-e-arrecada-mais-de-r-400-mil-para-realizar-o-sonho-da-casa-propria-de-crianca-carente/)) é um ativo de imagem alinhado ao universo das Loterias.
...
Comediante de São Paulo, roteirista. Stand-up solo **"Entra no Clima"**. Nas redes: 357 K no TikTok, 189 K no Instagram (8,82% de engajamento), 55 K inscritos e 22 M de views no YouTube. Reels como [**Paulista x Manauara**](https://www.instagram.com/p/DQ5VcFlCXfP/) passaram de 3,5 M de views. Portfólio de campanhas ([**Baobá Produções**](https://www.baobashows.com.br/felipehatori)): **Itaú**, **Nubank**, **Samsung**, **Skol**, **Colchões Emma**, **Growth**, **Insider** e **Xtay**. Integra os grupos [**Os Japas**](https://www.terra.com.br/visao-do-corre/role-de-quebrada/comediantes-dividem-o-stand-up-com-outros-trabalhos,2b17bc4210355338def823aa682a17360csl7fks.html) e **Bateu a Nave**.
...
Sem filiação, candidatura ou posicionamento político documentado. Conteúdo restrito a entretenimento.
...
- **Política:** Sem filiação, candidatura ou posicionamento político documentado.
- **Menor em cena (amostra pública):** **Não observado** — grade TikTok (capturas internas, **18–24** thumbnails, **maio/2026**): turismo, natureza, corridas, Uberlândia/MG; **sem menor de idade em destaque** nas caps. Perfil: [**TikTok @julimaranasciment**](https://www.tiktok.com/@julimaranasciment).
...
Sem polêmica nas fontes. Perfil regional, positivo, sem histórico de cancelamento ou polarização.

### Política e pautas sensíveis

Sem filiação, candidatura ou posicionamento político documentado. Perfil apolítico em estado eleitoralmente relevante em 2026.
