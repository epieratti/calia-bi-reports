# Público percebido — lote 3 (AON Loterias 2026)

**Pedido:** incluir no dossiê uma leitura sobre **perfil de público** (incluindo preocupação do cliente com **público infantil** no caso Linnyke Alves), **sem** prometer demografia.

**Escopo desta nota:** pesquisa **qualitativa** com base em **fontes públicas** (matérias, páginas oficiais de agenciamento, amostra de URLs de redes quando indexadas) + **alinhamento** ao que já consta em `data/dossier_loterias2026.md` (coleta **04/05/2026**).
...
- **Menor tensão** com a dúvida “público infantil” **versus** Linnyke: o **eixo do humor** e o **portfólio** empurham leitura para **18–40** (faixa ilustrativa, **não** dado de plataforma).
...
## Julimara — “Ju” (`@julimarasn`, YouTube `@omapadaminademinas`, TikTok `@julimaranasciment`)
...
- **Boa aderência temática** (“sonho”, **destino**, **sorte** no sentido de **experiência** — combina com **aspiração** de lazer mais do que com humor de massa viral); **monitorar** só se a peça for **hiper-urbana** e quiser contraste com **regional**.

### Evidências (links)

- Canal YouTube (marca “O Mapa da Mina de Minas”): [YouTube — @Omapadaminademinas](https://www.youtube.com/@Omapadaminademinas)
- Reel (turismo / experiência): [Instagram — reel DHyFbDcu_Qo](https://www.instagram.com/julimarasn/reel/DHyFbDcu_Qo/)
...
*Documento interno Calia — maio/2026. Não substitui briefing jurídico/compliance do cliente.*
