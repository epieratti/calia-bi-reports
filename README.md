...
- **Loterias 2026 (Brand Safety):** pesquisa em `loterias2026/research/`; dossiê HTML gerado com `python loterias2026/scripts/build_dossier_completo.py` → `loterias2026/output/20260401-dossie-squad-always-on-loterias-2026.html` (senhas `caixa2026` / `embratur2026`). Ver `loterias2026/README.md`.
