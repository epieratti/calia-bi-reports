...
```bash
make help
python3 engine/qa/validate_source.py --hints caminho/dossier_*.md
make dossie-entregar MD=... DEST=caixa/loterias   # exemplo
python3 engine/qa/check_html_leakage.py caixa embratur
```
...
FASE 1 — Abrir mentalmente: docs/tutorials/INICIO_AGENTE.md + PLAYBOOK_AGENTES.md.
