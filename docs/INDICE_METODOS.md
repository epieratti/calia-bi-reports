...
| **Tipos de gráfico** — qual usar em cada caso, como implementar (Chart.js); rosca/radar Embratur; modo B sem charts | [`PLAYBOOK_DOSSIES.md`](../PLAYBOOK_DOSSIES.md) — *Gráficos* |
