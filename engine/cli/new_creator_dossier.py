...
Uso:
  python3 engine/cli/new_creator_dossier.py meu_lote_2026 \\
    --output-dir projects/caixa/loterias/meu-lote/data --variant squad_13
"""
...
TEMPLATE = REPO_ROOT / "projects/_template/dossier_TEMPLATE.md"
REF_PANELS = {
    "squad_13": REPO_ROOT / "projects/caixa/loterias/always-on-20260401/data/dossier_loterias2026_panels.yaml",
    "squad_8": REPO_ROOT / "projects/caixa/loterias/always-on-20260406/data/dossier_loterias2026_panels.yaml",
}
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        type=Path,
        required=True,
        help="Pasta data/ do projeto (ex.: projects/caixa/loterias/meu-lote/data)",
    )
    ap.add_argument(
        "--variant",
    ...
    print()
    print("Próximo passo: edite meta/briefing no .md, crie manifest.yaml no projeto e publique:")
    print(f"  make dossie-entregar MD={md_out}")
