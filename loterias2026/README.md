...
- **Edição interna:** `data/dossier_loterias2026.yaml` (textos, tabelas, **`tier`** e **`resumo_tabela`** por perfil — linhas curtas para a matriz C-level; ordem de camadas em `briefing.tier_order`).
