---
meta:
  title: Concorrência publicitária Febraban — Brand Safety (creators)
  subtitle: Oito influenciadores propostos — métricas, concorrência bancária, bets, política e riscos.
...
briefing:
  ...
  intro_paragraphs:
    - '**Pedido:** checagem pré-apresentação de **8 creators** para a **Febraban** (associação **privada** que **representa** o setor — **não** é banco, **não** é órgão do governo nem administração pública; **regula** bancos o **BCB** e o **CMN**). Campanha **Desenrola 2.0** ([portal Febraban](https://portal.febraban.org.br/noticia/4429/pt-br/)). **Quem são os associados:** [lista oficial no portal](https://portal.febraban.org.br/pagina/3164/12/pt-br/associados/). Eixos: **métricas** (Social Blade), **histórico com bancos** (**sinalizar** quem consta nessa lista), **bets**, **política** (**sinalizar**, sobretudo em **ano eleitoral**), **polêmicas/reputação**.'
  ...
  criterios:
    - "Bancos / financeiras: mapear publi com **bancos associados Febraban** ([lista oficial](https://portal.febraban.org.br/pagina/3164/12/pt-br/associados/)) e **outras** financeiras — **sinalização**; só elevamos a alerta se houver **exclusividade** que conflite com a **nova** peça ou posicionamento **incompatível** com o recado."
...
consolidated_narrative:
  ...
  blocks:
    ...
    - title: Próximo passo operacional
      items:
        - "Pedir **media kit** ou **export** de métricas e **audiência** (idade, geografia) direto do creator — a tabela HTML é **termômetro**, não auditoria."
...
Exposição típica de celebridade de reality; campanha bancária amplamente comentada na época ([Buzzmonitor](https://buzzmonitor.com/blog/campanha-de-open-banking-do-santander-com-gil-do-vigor-alimenta-debates-nas-redes-sociais/)) — risco principal é **associação a concorrente**, não escândalo de conduta no que vimos.
...
- instagram: nathfinancas
- tiktok: nathfinancas
- youtube: nathfinancas
- x: nathfinancas
...
Não consta publi de casa de apostas. Menções a produtos de **poupança/CDB** e comparativos entre bancos aparecem como **conteúdo educativo** — ainda assim próximo do tema **sistema financeiro**.

### Polêmicas e situações delicadas

Conflito público de **registro de marca** com Nathalia Arcuri, com troca de acusações na imprensa ([Extra](https://extra.globo.com/economia/financas/noticia/2024/01/nath-financas-e-nathalia-arcuri-disputam-registro-de-marca-e-trocam-farpas-nas-redes-sociais.ghtml)).
...
- instagram: faveladoinvestidor
- tiktok: faveladoinvestidor
- youtube: faveladoinvestidor
- x: faveladoinvestidor
...
Não consta publicidade de casa de apostas. Oferta de **educação financeira** paga (Hotmart e similares).
...
Discurso de ascensão social e crítica à **elitização** do mercado financeiro; sem vínculo formal com partido no recorte.
...
Não consta publi de casa de apostas no recorte.

### Polêmicas e situações delicadas

Relato de **revista em casa** na **Maré** em **2023** ([Estadão](https://www.estadao.com.br/emais/gente/influencer-diz-que-casa-foi-invadida-em-operacao-policial-na-mare-muito-indignado-nprec/)). Tema **segurança pública e favela** costuma ser **reinterpretado** em períodos eleitorais ou crises.
...
Baixo a moderado — humor e moda; **ruído de mídia** com outra influencer.
...
- **Polêmicas:** “Treta” com outra creator coberta pela imprensa de celebridades.
- **Política:** Sem cargo público; entrevistas falam em **não centrar raça** no conteúdo, mas **existência política** como mulher negra ([Terra](https://www.terra.com.br/vida-e-estilo/comportamento/influenciadora-viraliza-como-sincerona-da-web-cansada-da-cultura-do-sucesso,dd13e3300d563b01bc0b8c76d431fe9a86de86k4.html)).

### Concorrência (bets / loterias / jogos)

**Não consta** publicidade paga de **banco concorrente**, **financeira** ou **casa de apostas** no recorte desta busca (abril/2026).

### Polêmicas e situações delicadas

Conflito **interpessoal** amplificado pela mídia ([Purepeople](https://www.purepeople.com.br/galeria/jade-seba-x-jacira-doce-criticas-e-trocas-de-farpas-entre-influenciadoras-geram-o-caos-na-web-entenda-a-treta_a400803/1)) — risco de **associação a fofoca** brand-unsafe leve.

### Política e pautas sensíveis

Pauta **feminista** e de **corpo** no humor; sem filiação partidária localizada.
...
Moderado — pautas **identitárias** e **crítica à internet**; sem banco/bet localizado.
...
- **Concorrência:** Não consta banco concorrente nem bet.
- **Polêmicas:** Ódio online e exposição como pessoa trans/não-binária — **vulnerabilidade a ataques**, não “escândalo de conduta”.
- **Política:** Ativismo de **direitos humanos** e gênero; sem cargo em governo localizado.
...
Conteúdo sobre **ódio digital** e **saúde mental** da creator em contexto de assédio ([Capricho](https://capricho.abril.com.br/comportamento/juvi-chagas-ensina-a-nos-levar-menos-a-serio-e-entender-que-a-vida-e-longa)).

### Política e pautas sensíveis

Pautas **progressistas** explícitas; avaliar **fit** com tom institucional da peça.
...
Moderado — **histórico público com Bradesco**; diversas marcas de massa.
...
- **Polêmicas:** Baixo no recorte — papel público em **diversidade** e moda ([Meio e Mensagem](https://www.meioemensagem.com.br/midia/marketing-de-influencia-diversidade-racial-e-motor-de-negocios)).
- **Política:** Pauta racial e de gênero; sem cargo em governo localizado.

### Concorrência (bets / loterias / jogos)

**Não consta** publicidade paga de **casa de apostas** no recorte; **banco:** histórico **Bradesco** (ver acima).

### Polêmicas e situações delicadas

Gestão de **múltiplos contratos** antigos — pedir **lista atualizada** de exclusividade e calendário de veiculações ([Meio e Mensagem](https://www.meioemensagem.com.br/midia/marketing-de-influencia-diversidade-racial-e-motor-de-negocios)).

### Política e pautas sensíveis

**Representatividade racial** e **consumo consciente** — alinhamento positivo para muitas marcas; sensível para narrativas **anti-“woke”** (se houver risco de audiência interna).

## Rafa Chalub (Esse Menino)

- **Camada:** Squad Febraban (8)

### Síntese de risco

Moderado — **humor político contínuo**; viralização com **Pfizer vs. Bolsonaro** (pandemia).
...
- **Concorrência:** Marcas de FMCG e entretenimento ([Fernanda Ribas](https://fernandaribas.com/talento/rafa-chalub)); sem publi de banco/bet localizada.
- **Polêmicas:** Humor que **incomoda** autoridades — risco de **corte descontextualizado**.
- **Política:** **Alta** — entrevistas e conteúdo com **eixo político** explícito.
...
Viralização histórica com **vacina** e **Executivo** — arquivo sensível em **saúde pública** e **polarização** (contexto em [Estado de Minas](https://www.em.com.br/politica/2024/03/6821723-humor-e-ferramenta-politica-afirma-humorista-esse-menino.html)).
