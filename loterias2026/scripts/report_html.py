...
<body class="bg-slate-50 text-slate-800 p-6 md:p-12">
  <div class="max-w-5xl mx-auto">
    <header class="mb-10 rounded-lg bg-slate-900 text-white p-8">
      ...
      <p class="text-xs opacity-70 mt-4">Gerado em {esc(generated)} · Fontes: Instagram, TikTok, YouTube, X (Apify), Wikipedia PT/EN, RSS de portais (config), Google Notícias, busca web (ddgs)</p>
    </header>
    {note_block}
