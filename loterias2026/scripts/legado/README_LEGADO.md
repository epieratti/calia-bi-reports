...
Os arquivos nesta pasta eram ou são um **pipeline experimental** com **Apify** e relatório HTML separado. **Apify foi retirado do fluxo** (não funcionou bem). Não configurar `APIFY_TOKEN` para trabalho normal.
...
**Uso (opcional):** `python3 scripts/legado/run_pipeline.py` a partir da pasta `loterias2026/`.
