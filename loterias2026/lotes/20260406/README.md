...
| `scripts/publish_to_caixa.sh` | Gera o HTML e copia para `caixa/` (motor em `loterias2026/scripts/build_dossier_completo.py`). |
...
```bash
./loterias2026/lotes/20260406/scripts/publish_to_caixa.sh
```

(Equivale a `make build-dossier-squad-8` + cópia para `caixa/`.)
