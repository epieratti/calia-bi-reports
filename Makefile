...
help:
	...
	@echo "  make build-dossier-squad-20260504 — gera HTML lote 04/05 em loterias2026-20260504/output/"
...
validate-dossier-squad-20260504:
	cd "$(ROOT)" && $(PYTHON) tools/validate_dossier_source.py loterias2026-20260504/data/dossier_loterias2026.md
...
check-links-squad-20260504:
	cd "$(ROOT)" && $(PYTHON) tools/check_dossier_links.py loterias2026-20260504/data/dossier_loterias2026.md
...
build-dossier-squad-8:
	cd "$(ROOT)" && $(BUILD) --project-root loterias2026-20260406

build-dossier-squad-20260504:
	cd "$(ROOT)" && $(BUILD) --project-root loterias2026-20260504
...
check-html-leakage:
	cd "$(ROOT)" && $(PYTHON) tools/check_client_html_leakage.py caixa embratur febraban loterias2026/output loterias2026-20260406/output loterias2026-20260504/output
