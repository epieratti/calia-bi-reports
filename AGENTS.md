...
| Loterias 2026 (pipeline) | `loterias2026/` | Playbook: `PLAYBOOK_DOSSIES.md`. Descobrir @ a partir de nome: `loterias2026/research/METODO_DESCOBERTA_PERFIS_CREATORS.md`. Novo lote: `new_creator_dossier.py`. Build: `build_dossier_completo.py`. Ver `loterias2026/README.md`. |
