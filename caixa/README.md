...
- **`20260506-dossie-isadora-cruz-cartao-caixa-2026.html`** — Perfil **Isadora Cruz** (cartão Caixa): **versão objetiva** (sumário curto, matriz única pedido+método+checklist, métricas IG/TikTok, mídia/política/brand safety unificados, sem gráficos Chart.js). TikTok **Upfluence**, **Social Blade** IG; **sem** X/YouTube próprios (brief). **Senha:** `caixa2026` ou `embratur2026`.
