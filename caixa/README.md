...
- **`20260515-dossie-rodolfo-macedo-foiorodolfo-caixa-2026.html`** — **Double check (riscos e marcas) — Rodolfo Macedo** (“Foi o Rodolfo”, @foiorodolfo; Squad Always ON Loterias · CAIXA): estrutura pensada para **conferência** depois do levantamento do time — na frente: **leitura executiva**, **parcerias e campanhas**, **checagem reputacional**, **pontos de atenção**, **painel Social Blade**; **material de apoio** (perfil, trajetória, redes, tom) em bloco recolhível opcional no HTML. **Redes:** Instagram, TikTok, YouTube, Facebook, Kwai, Threads, Snapchat (histórico); **sem** conta no X/Twitter com @foiorodolfo; **pesquisa complementar** (YouTube Shorts, apostas, PDF RIC 5248/2025, PDF O Imparcial 2016); parcerias com critério por link (15/05/2026 + revalidação; **O Imparcial** jan/2017, **BRK** / Lava Pratos fev/2026, RIC). **Senha:** `caixa2026` ou `embratur2026`. **No ar:** [GitHub Pages](https://epieratti.github.io/calia-bi-reports/caixa/20260515-dossie-rodolfo-macedo-foiorodolfo-caixa-2026.html).
