...
- **`20260515-dossie-rodolfo-macedo-foiorodolfo-caixa-2026.html`** — **Dossiê Squad Always ON Loterias — Rodolfo Macedo** (“Foi o Rodolfo”, @foiorodolfo; Maranhão; Loterias Caixa · Always ON): **redes** Instagram, TikTok, YouTube, **Facebook**, **Kwai**, **Threads**, Snapchat (histórico) e **X** (sem @ oficial; SB sem Twitter/X), **painel Social Blade** (IG/TT/YT), **pesquisa complementar integrada** (formatos Shorts, strings de busca em bets, PDF RIC 5248/2025 na Câmara, PDF O Imparcial 2016), **checagem reputacional** ampliada, metodologia e fontes com URL. **Senha (HTML):** `caixa2026` ou `embratur2026`. **No ar:** [HTML](https://epieratti.github.io/calia-bi-reports/caixa/20260515-dossie-rodolfo-macedo-foiorodolfo-caixa-2026.html).
