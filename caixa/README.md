...
- **`20260506-dossie-isadora-cruz-cartao-caixa-2026.html`** — Perfil **Isadora Cruz** (cartão Caixa): **matriz** em duas colunas (pedido → resposta, com observações na mesma célula), **universo de evidência** no método (inclui busca em **Meio e Mensagem** / PROPmark / AdNews); **painel Chart.js**, **timeline**; **Nio Fibra** (campanhas 2025–26, links na seção Marcas); **Osklen** (RFW 2026, Gshow/Terra); **#instagram-marcas** (C&A, Rolex, Mugler etc. conforme interface IG + revalidação); **Sicoob** no bloco **#sicoob-novela** (referência única); **fontes** compactas. TikTok **Upfluence**, **Social Blade** IG; **sem** X/YouTube próprios (brief). **Senha:** `caixa2026` ou `embratur2026`.
