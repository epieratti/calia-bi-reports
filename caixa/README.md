...
- **`20260514-dossie-pulga-oncoto-caixa-2026.html`** — Creator **Pulga** (Wallace Soares / Wallace Santos Soares, @pulga.oncoto; TikTok @pulga.choraboy): **levantamento breve** (identidade, trajetória na imprensa, **outras plataformas** — TikTok, YouTube indireto, X — **painel Social Blade (IG) + Upfluence/SB (TT)**, **due diligence** apostas/loterias/polêmicas, **anexo** com síntese de pesquisa complementar (Deep Research — **validar fontes**), tom, brand safety, limitações). **Senha (HTML):** `caixa2026` ou `embratur2026`. **No ar:** [HTML](https://epieratti.github.io/calia-bi-reports/caixa/20260514-dossie-pulga-oncoto-caixa-2026.html).
