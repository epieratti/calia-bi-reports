...
- **`20260515-dossie-rodolfo-macedo-foiorodolfo-caixa-2026.html`** — **Dossiê Squad Always ON Loterias — Rodolfo Macedo** (“Foi o Rodolfo”, @foiorodolfo; Maranhão; Loterias Caixa · Always ON): **redes** Instagram, TikTok, YouTube, **Threads**, Snapchat (histórico na matéria) e **X** (sem @ oficial confirmado; Social Blade sem métricas de Twitter/X), **painel Social Blade** (IG/TT/YT) + referência cruzada YouTubers.me, **checagem reputacional** (concorrência de loteria/apostas, política, temas sensíveis, BBB), metodologia e fontes com URL. **Senha (HTML):** `caixa2026` ou `embratur2026`. **No ar:** [HTML](https://epieratti.github.io/calia-bi-reports/caixa/20260515-dossie-rodolfo-macedo-foiorodolfo-caixa-2026.html).
