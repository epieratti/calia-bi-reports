...
- **`20260506-dossie-isadora-cruz-cartao-caixa-2026.html`** — Perfil **Isadora Cruz** (cartão Caixa): matriz (coluna **Limite / gap**), **rubrica de auditoria** expansível, **universo de evidência** no método; **painel Chart.js**, **timeline**; **Sicoob** explicado no bloco **#sicoob-novela** (referência única; demais seções remetem a ele); **fontes** compactas; limites na linha **Outros**. TikTok **Upfluence**, **Social Blade** IG; **sem** X/YouTube próprios (brief). **Senha:** `caixa2026` ou `embratur2026`.
