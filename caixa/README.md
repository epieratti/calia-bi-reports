...
- **`20260515-dossie-rodolfo-macedo-foiorodolfo-caixa-2026.html`** — **Dossiê Squad Always ON Loterias — Rodolfo Macedo** (“Foi o Rodolfo”, @foiorodolfo; Maranhão; Loterias Caixa · Always ON): **redes** Instagram, TikTok, YouTube, **Facebook**, **Kwai**, **Threads**, Snapchat (histórico); **sem conta no X/Twitter** com @foiorodolfo (menções de terceiros podem existir), **painel Social Blade** (Instagram, TikTok e YouTube), **pesquisa complementar incorporada** (vídeos curtos no YouTube, buscas por apostas, PDF RIC 5248/2025 na Câmara, PDF O Imparcial 2016), **parcerias e campanhas documentadas** (critério com link; rodada 15/05/2026 + revisão com revalidação de URLs; exemplos: **O Imparcial** jan/2017, **BRK** / Lava Pratos em blog fev/2026, RIC), **checagem reputacional** ampliada, metodologia e **fontes com hiperlinks**. **Senha de acesso:** `caixa2026` ou `embratur2026`. **No ar:** [dossiê no GitHub Pages](https://epieratti.github.io/calia-bi-reports/caixa/20260515-dossie-rodolfo-macedo-foiorodolfo-caixa-2026.html).
