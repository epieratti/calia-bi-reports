...
- **`20260506-dossie-isadora-cruz-cartao-caixa-2026.html`** — Perfil **Isadora Cruz** para apoio a ação de **cartão de crédito** (levantamento + **deep research** maio/2026; **painel com gráficos** Chart.js, timeline de marcas, identidade Calia). **Senha:** `caixa2026` (ou `embratur2026`, mesmo padrão do dossiê 20260326).
