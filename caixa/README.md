...
- **`20260506-dossie-isadora-cruz-cartao-caixa-2026.html`** — Perfil **Isadora Cruz** (cartão Caixa): estrutura **objetiva** (matriz pedido+método+checklist, seções unificadas) com **painel Chart.js** (rosca de temas + radar de risco), **timeline** de marcas, **prosa revisada** (coesão, conectivos) e bloco **Sicoob na novela** (*Coração Acelerado*, merchandising Globo, fontes Valor/Gshow). TikTok **Upfluence**, **Social Blade** IG; **sem** X/YouTube próprios (brief). **Senha:** `caixa2026` ou `embratur2026`.
