...
- **`20260506-dossie-isadora-cruz-cartao-caixa-2026.html`** — Perfil **Isadora Cruz** (cartão Caixa): **matriz** em duas colunas (pedido → resposta, com observações na mesma célula), **universo de evidência** no método; **painel Chart.js**, **timeline**; **Sicoob** no bloco **#sicoob-novela** (referência única); **fontes** compactas. TikTok **Upfluence**, **Social Blade** IG; **sem** X/YouTube próprios (brief). **Senha:** `caixa2026` ou `embratur2026`.
