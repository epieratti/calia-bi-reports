...
- **`20260514-dossie-pulga-oncoto-caixa-2026.html`** — Creator **Pulga** (Wallace Soares / Wallace Santos Soares, @pulga.oncoto): **levantamento breve** (identidade, trajetória na imprensa, tom, brand safety, limitações). **Senha (HTML):** `caixa2026` ou `embratur2026`. **No ar:** [HTML](https://epieratti.github.io/calia-bi-reports/caixa/20260514-dossie-pulga-oncoto-caixa-2026.html).
