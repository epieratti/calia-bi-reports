...
- **`20260506-dossie-isadora-cruz-cartao-caixa-2026.html`** — Perfil **Isadora Cruz** para apoio a ação de **cartão de crédito** (levantamento + rodada **deep research** maio/2026: redes, marcas, política, espiritualidade, brand safety, lacunas). **Senha:** `caixa2026` (ou `embratur2026`, mesmo padrão do dossiê 20260326).
