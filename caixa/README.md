...
- **`20260514-dossie-pulga-oncoto-caixa-2026.html`** — Creator **Pulga** (Wallace Soares / Wallace Santos Soares, @pulga.oncoto; TikTok @pulga.choraboy), **contexto Quina de São João** (Loterias Caixa): **levantamento breve** (identidade, **linha do tempo**, trajetória na imprensa, **outras plataformas** — TikTok, YouTube indireto, X — **painel Social Blade (IG) + Upfluence/SB (TT)**, **due diligence** ampliada — apostas/loterias/rifas, política, saúde, parcerias, **homonímia em diários TJPA** e **listagem TJMG**, tom, brand safety, limitações). **Senha (HTML):** `caixa2026` ou `embratur2026`. **No ar:** [HTML](https://epieratti.github.io/calia-bi-reports/caixa/20260514-dossie-pulga-oncoto-caixa-2026.html).
