...
- **`20260515-dossie-rodolfo-macedo-foiorodolfo-caixa-2026.html`** — **Dossiê Squad Always ON Loterias — Rodolfo Macedo** (“Foi o Rodolfo”, @foiorodolfo; Maranhão; Loterias Caixa · Always ON): **redes** Instagram, TikTok, YouTube e exploração de **X**, **checagem reputacional** (concorrência de loteria/apostas, política, temas sensíveis, BBB), **painel** (Instagram via matéria 2020 + YouTube via YouTubers.me), metodologia e fontes com URL. **Senha (HTML):** `caixa2026` ou `embratur2026`. **No ar:** [HTML](https://epieratti.github.io/calia-bi-reports/caixa/20260515-dossie-rodolfo-macedo-foiorodolfo-caixa-2026.html).
