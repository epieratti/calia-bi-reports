...
- **`20260506-dossie-isadora-cruz-cartao-caixa-2026.html`** — Perfil **Isadora Cruz** (cartão Caixa): matriz pedido+método+checklist, **painel Chart.js**, **timeline** de marcas, bloco **Sicoob na novela** (contrato **Globo × Sicoob**), **fontes** em bloco compacto (colunas); limites gerais na linha **Outros** da matriz (sem seção “Lacunas”). TikTok **Upfluence**, **Social Blade** IG; **sem** X/YouTube próprios (brief). **Senha:** `caixa2026` ou `embratur2026`.
