# YouTube — pesquisa de canais (squad 06/04/2026)

**Data da verificação:** 2026-04-06 (com **2ª passagem** por nome + handle — ver `YOUTUBE_PESQUISA_NOME.md`).  
**Método:** confirmação de página ativa em `https://www.youtube.com/@<handle>` (HTTP 200 + título do canal coerente com o nome), exceto onde indicado.
...
| Ademara | @ademara | **Sim** (dois UCs) | [@ademara](https://www.youtube.com/@ademara) e [@ademara0](https://www.youtube.com/@ademara0) — **canais distintos**; o [Linktree](https://linktr.ee/ademaravilha) usa **@ademara0**. |

## Notas

- **Rafael Saraiva (comediante / Porta dos Fundos):** ausência de canal próprio não impede presença em vídeos de outros canais; para métricas de **canal próprio**, fica em aberto até existir `@` público ou confirmação direta.
- **Pedro Ottoni:** métricas de canal próprio no YouTube: **@PedroOttoni** (ver também `SOCIAL_BLADE_YOUTUBE.md` — SB pode ainda não indexar o `UC…`).
- **Julia Ferrari:** duas personalidades de URL no YouTube; para alinhar ao IG **@julia_ferrari**, usar **@julia_ferrari**; o SB pode mostrar sob **@juliaferraric** — tratar como canais diferentes nos números.
